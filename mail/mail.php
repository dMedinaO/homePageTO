...
if(isset($_POST['email'])) {
	...
	$transport = Swift_SmtpTransport::newInstance('smtp.gmail.com', 25, 'tls' )
	  ->setUsername('contactoogazexpress@gmail.com')
	...
	$message = Swift_Message::newInstance('Nuevo mensaje desde toexpress.cl')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('ogazexpress@gmail.com' => 'Estimado Paulo'))->setBody($messageText);
//                           ^                    ^
